...
export class ApplyLayoutPresetCommand extends CommandBase<ApplyLayoutPresetPayload, ApplyLayoutPresetPayload> {
    ...
    postCommit(_context: CommandContext, payload: ApplyLayoutPresetPayload): CommandUndoPayload<ApplyLayoutPresetPayload> {
        return payload;
    }
