 ...
 */
export type CommandTelemetryStatus =
...
export interface Command<TExecutePayload = void, TUndoPayload = void> {
	...
	execute(context: CommandContext):
		| CommandExecutionResult<TExecutePayload>
		| Promise<CommandExecutionResult<TExecutePayload>>;

	postCommit?(context: CommandContext, payload: TExecutePayload):
		| CommandUndoPayload<TUndoPayload>
		| Promise<CommandUndoPayload<TUndoPayload>>;
}
