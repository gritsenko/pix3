 ...
 */
export class SineOscillator extends Script {
      ...
      properties: [
        {
          ...
          getValue: (component: unknown) => (component as SineOscillator).config.amplitude,
          setValue: (component: unknown, value: unknown) => {
            (component as SineOscillator).config.amplitude = Number(value);
          },
        },
        {
          name: 'frequency',
          ...
          getValue: (component: unknown) => (component as SineOscillator).config.frequency,
          setValue: (component: unknown, value: unknown) => {
            (component as SineOscillator).config.frequency = Number(value);
          },
        },
        {
          name: 'axis',
          ...
          getValue: (component: unknown) => (component as SineOscillator).config.axis,
          setValue: (component: unknown, value: unknown) => {
            (component as SineOscillator).config.axis = value;
          },
        },
      ],
      groups: {
